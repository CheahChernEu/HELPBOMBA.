  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item ">
          <a class="nav-link ms-5" href="#footer">Organize Trip</a>
        </li>
      </ul>
    </div>
  </div>
  ...
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="tripModalLabel">Create New Trip</h5>
      ...
      <div class="modal-body">
        <form>
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="cType" required>
          </div>
          <div class="mb-3">
            <label for="numVol" class="col-form-label">Amounts of volunteers required</label>
            <input type="number" class="form-control" id="numVolunteers" required>
          </div>
        </form>
      </div>
    ...
    <div class="container p-4 pb-0">
      ...
      <section class="">
        <p class="d-flex justify-content-center align-items-center">
          <span class="me-3" style="color: pink; font-size: 25px;">Organize Trip: </span>
          <button type="button" id="btnOrganize" class="btn btn-outline-light btn-rounded" data-bs-toggle="modal" data-bs-target="#tripModal">
            Organize Trip Here!
          </button>
        </p>
      </section>
